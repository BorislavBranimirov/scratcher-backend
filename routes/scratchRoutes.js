...
router.route('/').post(verifyAccessToken, scratchController.createScratch);

router.route('/search').get(passUserInfo, scratchController.searchScratches);
...
router
  .route('/:id/direct-rescratch')
  .delete(verifyAccessToken, scratchController.deleteRescratchById);

router
  .route('/:id/rescratches')
  .get(verifyAccessToken, scratchController.getUsersRescratchedByScratchId);

router.route('/:id/pin').post(verifyAccessToken, scratchController.pinScratch);
